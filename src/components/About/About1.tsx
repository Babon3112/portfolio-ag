...
const About1 = () => {
  ...
  return (
    ...
    >
      <div className="border border-gray-300 rounded-2xl bg-gray-50 w-[23rem] mobile:w-[40rem] tablet:w-80 dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="mt-4 mb-9 w-full flex-col flex justify-center items-center">
          <h1 className="text-4xl font-playwrite font-bold mb-3 text-gray-900 dark:text-gray-50">
            Arnab Ghosh
          </h1>
          <p className="text-sm text-gray-600 ml-10 mr-10 dark:text-gray-400 ">
