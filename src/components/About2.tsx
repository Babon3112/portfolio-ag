    ...
    >
      <div className="flex justify-evenly items-center h-24 border border-gray-300 bg-white rounded-xl w-[21rem] mobile:w-[40rem] tablet:w-80 mt-8">
        ...
        {/* <Link
          ...
          target="_blank"
          className="border border-[#2b3137] rounded-full bg-white hover:bg-[#2b3137] transition-colors duration-200"
        >
          <svg
            className="p-2 hover:fill-white fill-[#2b3137]"
            height={40}
            width={40}
            viewBox="-2.5 0 19 19"
          >
        ...
        <Link
          ...
          target="_blank"
          className="border border-[#0077B5] rounded-full bg-white hover:bg-[#0077B5] transition-colors duration-200"
        >
          <svg
            viewBox="0 -2 44 44"
            className="p-2.5 fill-[#0077B5] hover:fill-white"
            height={40}
            width={40}
          >
        ...
        <Link
          ...
          target="_blank"
          className="border border-[#5865f2] rounded-full bg-white hover:bg-[#5865f2] transition-colors duration-200"
        >
          <svg
            height={40}
            width={40}
            className="p-2 fill-[#5865f2] hover:fill-white"
            viewBox="0 0 16 16"
          >
        ...
        <Link
          ...
          target="_blank"
          className="border border-[#24a1de] rounded-full bg-white hover:bg-[#24a1de] transition-colors duration-200"
        >
          <svg
            className="p-2.5 hover:fill-white fill-[#24a1de]"
            viewBox="0 0 300 300"
            height={40}
            width={40}
          >
        ...
        <Link
          ...
          target="_blank"
          className="border border-[#25d366] rounded-full bg-white hover:bg-[#25d366] transition-colors duration-200"
        >
          <svg
            height={40}
            width={40}
            className="p-2.5 hover:fill-white fill-[#25d366]"
            viewBox="0 0 16 16"
          >
